...
import { MAGIC_MIME_ENCODING, MAGIC_MIME_TYPE, Magic } from 'mmmagic';
...
function fileAsBlob ( options ) {
	...
	var magic = new Magic(MAGIC_MIME_TYPE | MAGIC_MIME_ENCODING);
		...
		load: function load ( id ) {
			...
			return new Promise(function (res){
				...
				magic.detectFile(id, function (err, mime){
					...
					var data = readFileSync( id, readEncoding );
